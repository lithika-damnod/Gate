...
public class Event {
    ...
    public EventResponse toResponse() {
        return EventResponse.builder()
                ...
                .ticketTypes(this.ticketTypes.stream().map(ticketType -> new TicketTypeDTO(ticketType.getId(), ticketType.getType(), ticketType.getPrice() ,ticketType.getTotal(), ticketType.getMaxTicketCapacity(), ticketType.getTicketReleaseRate(), ticketType.getNumberOfTickets())).collect(Collectors.toList()))
                .status(this.status)
