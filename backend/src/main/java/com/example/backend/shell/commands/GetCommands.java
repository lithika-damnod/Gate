...
import com.example.backend.shell.service.ShellTicketService;
import com.example.backend.shell.service.ShellUserService;
...
public class GetCommands {
    ...
    private final ShellTicketService shellTicketService;
    ...
    public void get(
        ...
        switch (type.toLowerCase()) {
            ...
            case "ticket" -> shellTicketService.get(id == null ? null : Integer.parseInt(id));
            case "user" -> shellUserService.get(id == null ? null : Integer.parseInt(id));
            default -> System.out.println("\u001B[31mInvalid type. Valid options are: vendor, ticket, user, event.\u001B[0m");
        };
    }
}
